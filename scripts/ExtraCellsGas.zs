...
var formmationCore = <appliedenergistics2:item.ItemMultiMaterial:43>;

recipes.addShaped(<extracells:part.base:13>, [[lapius, annilationCore, lapius], [iron, gasTank, iron], [null, null, null]]);

recipes.addShaped(<extracells:part.base:14>, [[lapius, formmationCore, lapius], [iron, gasTank, iron], [null, null, null]]);